...
public class pastOrder implements Parcelable {
	...
	public pastOrder(String brandObjectId, String objectId, String brandName, String name, String category, String pictureURL, int cost, int shippingCost, int tax, String description, int numberOfItemsInStock, ArrayList<String> options, ArrayList<Integer> optionsCost) {
