package com.enormous.pkpizzas.consumer.services;
 ...
 * 
 * When App Detects beacon for the first time, Notification is generated. After that notifications from the same consumer wont be seen for 24Hrs.
