...
import com.enormous.pkpizzas.consumer.models.Item;
...
public class BrandInfoActivity extends FragmentActivity{
	...
	private void setUpHeader(View header) {
		...
		ImageLoader.getInstance().displayImage(this, selectedBrand.getCover(), brandCoverImageView, false, 640, 640, 0);
		ImageLoader.getInstance().displayImage(this, selectedBrand.getCoverPictureUrl(), brandCategoryImageView, false, 300, 300, 0);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.ic_action_profile:
			Intent goToProfile = new Intent(BrandInfoActivity.this, ProfileActivity.class);
